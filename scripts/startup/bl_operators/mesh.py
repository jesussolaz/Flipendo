...
# `mesh.faces_mirror_uv` (la clase MeshMirrorUV que habia aqui) es C++ nativo desde
# 2026-09-11 (Flipendo carril C): source/blender/editors/mesh/mesh_faces_mirror_uv.cc.
