...
# `register_tool` y `unregister_tool` se retiran con el armazon de herramientas.
#
# Servian para que un addon anadiera herramientas al catalogo de
# `bl_ui/space_toolsystem_toolbar.py`, mutando sus listas. Ese catalogo ya no existe:
# es nativo (`source/blender/windowmanager/toolsystem/`, 160 herramientas) y no se
# muta en ejecucion. Es una capacidad que se pierde a proposito, y estaba escrita como
# tal en politicas/TOOLSYSTEM-A-CPP.md desde el analisis: sin interprete no hay
# herramientas de terceros. Las 160 de Flipendo no se ven afectadas.
