...
const ToolDecl grab = {
    ...
    /*keymap_fallback*/ "Image Editor Tool: Uv, Grab (fallback)",
    /*brush_type*/ nullptr,
    /*data_block*/ nullptr,
    /*op*/ nullptr,
...
const ToolDecl relax = {
    ...
    /*keymap_fallback*/ "Image Editor Tool: Uv, Relax (fallback)",
    /*brush_type*/ nullptr,
    /*data_block*/ nullptr,
    /*op*/ nullptr,
    /*options*/ TOOL_OPTION_KEYMAP_FALLBACK,
...
const ToolDecl pinch = {
    ...
    /*keymap_fallback*/ "Image Editor Tool: Uv, Pinch (fallback)",
    /*brush_type*/ nullptr,
    /*data_block*/ nullptr,
    /*op*/ nullptr,
    /*options*/ TOOL_OPTION_KEYMAP_FALLBACK,
