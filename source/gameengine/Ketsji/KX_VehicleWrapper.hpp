...
class KX_VehicleWrapper : public EXP_Value {
  Py_Header
      ...
      public : KX_VehicleWrapper(PHY_IVehicle *vehicle);
  ...
  static PyObject *pyattr_get_ray_mask(EXP_PyObjectPlus *self,
                                       const struct EXP_PYATTRIBUTE_DEF *attrdef);
  static int pyattr_set_ray_mask(EXP_PyObjectPlus *self,
                                 const struct EXP_PYATTRIBUTE_DEF *attrdef,
                                 PyObject *value);
