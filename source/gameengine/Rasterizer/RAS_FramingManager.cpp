                                         ...
                                         RAS_Rect &viewport)
{
  ...
  switch (type) {
    ...
    case RAS_FrameSettings::e_frame_bars: {
      ComputeBestFitViewRect(availableViewport, design_aspect_ratio, viewport);
  ...
  switch (type) {
    case RAS_FrameSettings::e_frame_extend: {
      ...
      switch (sensor_fit) {
        ...
        default: {
          RAS_Rect vt;
          ComputeBestFitViewRect(availableViewport, design_aspect_ratio, vt);
                                      ...
                                      RAS_FrameFrustum &frustum)
{
  ...
  ComputeDefaultOrtho(
      camnear, camfar, scale, design_aspect_ratio, sensor_fit, shift_x, shift_y, frustum);
