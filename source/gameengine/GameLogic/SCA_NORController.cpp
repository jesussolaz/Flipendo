...
SCA_NORController::SCA_NORController(SCA_IObject *gameobj) : SCA_IController(gameobj)
{
}
...
/* Integration hooks ------------------------------------------------------- */
PyTypeObject SCA_NORController::Type = {PyVarObject_HEAD_INIT(nullptr, 0) "SCA_NORController",
