...
SCA_CameraActuator::SCA_CameraActuator(SCA_IObject *gameobj,
                                       SCA_IObject *obj,
                                       float hght,
                                       float minhght,
                                       float maxhght,
...
bool SCA_CameraActuator::Update(double curtime)
{
  ...
  actormat[0][0] = mat[0][0];
  actormat[0][1] = mat[1][0];
  actormat[0][2] = mat[2][0];
  actormat[1][0] = mat[0][1];
  actormat[1][1] = mat[1][1];
  actormat[1][2] = mat[2][1];
  actormat[2][0] = mat[0][2];
  actormat[2][1] = mat[1][2];
  actormat[2][2] = mat[2][2];
                                          ...
                                          PyObject *value)
{
  ...
  if (!ConvertPythonToGameObject(self->GetLogicManager(),
                                 value,
                                 &gameobj,
                                 true,
                                 "actuator.object = value: SCA_CameraActuator"))
