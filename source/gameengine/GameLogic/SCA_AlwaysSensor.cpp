...
SCA_AlwaysSensor::SCA_AlwaysSensor(class SCA_EventManager *eventmgr, SCA_IObject *gameobj)
...
/* Integration hooks ------------------------------------------------------- */
PyTypeObject SCA_AlwaysSensor::Type = {PyVarObject_HEAD_INIT(nullptr, 0) "SCA_AlwaysSensor",
